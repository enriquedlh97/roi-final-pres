  ...
  return (
    <TeamSlide
      members={[
        ...
        { name: "Martina", role: "MS CSE Polimi", initials: "M", color: "bg-rose-600", linkedin: "https://www.linkedin.com/in/martina-maiorana-6baa97254/", photo: `${BASE}/team-martina.png` },
      ]}
    />
  );
}
