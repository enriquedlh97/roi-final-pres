...
const REGIONS = [
  {
    ...
    surface: "banner",
    crops: 3,
    note: "3 black banners across the court. Temporal SSIM 0.9999 — visually identical to V68 gold.",
    image: "crops_back_3.png",
  },
  {
    ...
    surface: "banner",
    crops: 2,
    note: "Red Bull logo on the side panel. Edge realism + texture-match the binding constraints.",
    image: "crops_left_2.png",
  },
  {
